...
const AudioPlayer = () => {
  ...
  const streams = [
    ...
    { id: 6, title: "CKMS", url:"https://studio.radiowaterloo.ca:8443/radiowaterloo", about:"12.7 FM - CKMS is based at the University of Waterloo in Ontario"}, // 	CKMS-FM Radio Waterloo DI
