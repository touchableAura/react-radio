...
const AudioPlayer = () => {
  ...
  const streams = [
    ...
    { id: 6, title: "CKMS", url:"https://studio.radiowaterloo.ca:8443/radiowaterloo", about:"12.7 FM - CKMS is based at the University of Waterloo in Waterloo, Ontario"}, // 	CKMS-FM Radio Waterloo DI
    { id: 7,  title: "CKUW", url: "http://shout.mtl.gameservers.com:9025/;?type=http&nocache=10037", about: "95.9 FM - CKUW is based at the University of Winnipeg in Winnipeg, Manitoba"}, // CKUW 95.9 University of Winnipeg, MB
    ...
    { id: 9, title: "CFUV", url: "http://cfuv.streamon.fm:8000/CFUV-64k.aac",about:"101.9 FM - CFUV is based at the University of Victoria in Victoria, British Columbia" }, // CFUV 101.9 University of Victoria, BC
    ...
    { id: 13, title: "NTS1", url: "http://stream-relay-geo.ntslive.net/stream", about:"NTS is a global radio platform broadcasting music from over 50 cities around the globe, live 24/7." }, // global channel 1
    { id: 14, title: "NTS2", url: "http://stream-relay-geo.ntslive.net/stream2", about:"NTS is a global radio platform broadcasting music from over 50 cities around the globe, live 24/7."} // global channel 2
